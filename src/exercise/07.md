...
- Key props are necessary due to the React virtual DOM and rerendering
  confusions it might experience, usually due to changing state perpetrated by
  users
  - Unique key props help to keep the state changed through rerenders
- Key props shouldn't be indexes. Need to be unique to the array element
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=07%3A%20Rendering%20Arrays&em=alexblyth%40pm.me).
