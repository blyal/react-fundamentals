...
- Refs are objects that stay consistent between renders of React components
- Refs can be used to get form values
- Double negation (i.e. !!value) can be replaced by Boolean(value)
- Use a state + handleChange + input value property to control/amend the user's
  input as they type
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=06%3A%20Forms&em=alexblyth%40pm.me).
