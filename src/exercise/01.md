...
- Can directly manipulate the document body via document.body
- Can set IDs via setElement("id", "new-id-whatever")
- Can use pure JS to manipulate the classes of DOM elements
  (whateverDivElement.className = "x")
- Also the text content (whateverDivElement.textContent = "xyz")
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=01%3A%20Basic%20JavaScript-rendered%20Hello%20World&em=alexblyth%40pm.me).
